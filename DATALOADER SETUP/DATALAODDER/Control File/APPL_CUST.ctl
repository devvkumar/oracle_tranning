...
--   table. It is called by the "  Data Load Process" Concurrent Program.
--
--   The "  Upload Process"  will then be run to Load Setup Customer,Job Type,City-State,Market values 
--
--==================================================================================================================================
--PRE-REQUISITES:
--
...
ATTRIBUTE7                      "XXQGEN_COMMON_UTILS_PKG.REMOVE_SPL_CHAR(REPLACE(LTRIM(RTRIM(:ATTRIBUTE7)),CHR(34),NULL))",

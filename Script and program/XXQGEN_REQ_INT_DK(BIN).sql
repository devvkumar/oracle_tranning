...
--    
--    TYPE REC_PO_REQ IS TABLE OF TBL_TYPE_PO_REQ%ROWTYPE INDEX BY PLS_INTEGER;
--    
--    PO_REQ_TBL          REC_PO_REQ;
  
        PROCEDURE PROCESS_DATA(P_BATCH_ID NUMBER) IS
        
--        CURSOR CUR_PO_REQ_DATA(HDR_ID NUMBER, LIN_ID NUMBER) IS
--        SELECT PRHA.SOURCE_CODE,
--            PRHA.ORG_ID,
--            PRHA.HEADER_ID,
--            PRHA.REQ_NUMBER,
...
--    FOR I IN 1..CUR_PO_REQ.COUNT 
--        FOR J IN CUR_PO_REQ_DATA LOOP
--        
--        END LOOP;
--    END LOOP;
